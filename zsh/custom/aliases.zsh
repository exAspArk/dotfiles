...
vmp3chunk() {
  ...
  ffmpeg -i $1 -vn -acodec libmp3lame -ac 1 -ar 22050 -b:a 32k -f segment -segment_time $(echo "$segment_time * 60" | bc) -reset_timestamps 1 -segment_format mp3 "$filename_without_ext_%01d.mp3"
}
